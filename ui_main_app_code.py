...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.welcome_texte.setAlignment(Qt.AlignCenter)

        self.verticalLayout_2.addWidget(self.welcome_texte)
        ...
        self.gridLayout.addWidget(self.erruer_sign_password2, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.erreur_sign_password1, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.sign_password, 7, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_6, 11, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.login_password, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.log_in_password, 4, 1, 1, 1)
        ...
        self.bien_nomPutlisateur.setAlignment(Qt.AlignCenter)
    ...
    def retranslateUi(self, Form):
        ...
        self.erreur_sign_nom.setText(QCoreApplication.translate("Form", u"nom invalide", None))
